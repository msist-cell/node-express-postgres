...
const sequelize = new Sequelize(dbConfig.DB, dbConfig.USER, dbConfig.PASSWORD, {
  ...
  dialectOptions: {
    ssl: {
      ...
      rejectUnauthorized: false // Acepta certificados autosellados o no verificados (útil en entornos no productivos)
    }
  },
...
// Importamos el modelo de cliente desde la carpeta actual y lo registramos en el objeto 'db'
